...
import { USER_COMMANDS, setAdminCommandsForUser } from "./commands";

/**
 * Publishes the command menu: user commands globally, admin commands for every
 * known admin. Safe to run repeatedly.
 */
